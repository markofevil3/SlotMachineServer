...
public class SlotCombinationZombie extends SlotCombinations {
	
	public static final String DATA_FILE_PATH = "/data/SlotMachineZombie.txt";
  ...
  public SlotCombinationZombie() {
  	Util.log("SlotCombinationZombie Init");
  	random = new Random();
  	initGameData();
  }
	...
	public static void initGameData() {
		try {
			...
			Util.log("-----UPDATE SLOT ZOMBIE DATA-----");
			while (line != null) {
			...
			Util.log("SlotCombinationZombie:IOException:"	+ e.toString());
		}
	}
}
